...
#. use the search functionality `here <https://github.com/natalieda/nd_package/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the nd-package repository on GitHub;
